	...
	<div id="login">
		<div class="container">
			<h3 class="text-center text-info">
				<fmt:message key="register.addlecturer" />
			</h3>
			<form id="login-form" class="form"
				action="?command=REGISTER&lecturer=true" method="post">
				<div class="row">
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="patronym" class="text-info"><fmt:message
								...
								name="patronym" id="patronym" class="form-control"
								value="Userovych">
						</div>
						<div class="form-group">
							<label for="email" class="text-info"><fmt:message
								...
								value="standinalone96@gmail.com">
						</div>
					</div>
				</div>
				<div class="form-group">
