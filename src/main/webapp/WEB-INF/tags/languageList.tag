...
<!-- <h2> -->
<%-- 	<font color="black">${greeting}, ${name}!</font> --%>
<!-- </h2> -->
...
<div class="input-group align-items-center">
	...
	<form action="?command=CHANGE_LANGUAGE" method="post">
		<input class="btn btn-link" name="newLanguage" type="submit"
			value="en"> <input type="hidden" name="page"
			value="${ pageContext.request.queryString }" />
	</form>
	|
	<form action="?command=CHANGE_LANGUAGE" method="post">
		<input class="btn btn-link" name="newLanguage" type="submit"
			value="ru"> <input type="hidden" name="page"
			value="${ pageContext.request.queryString }" />
	</form>
</div>